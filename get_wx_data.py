...
logger.debug (wx)
logger.info ("location        : " + str(wx['location']))
logger.info ("calc_time       : " + str(wx['calc_time']))
logger.info ("wind_deg        : " + str(wx['wind_deg']))
logger.info ("wind_gust       : " + str(wx['wind_gust']))
logger.info ("wind_speed      : " + str(wx['wind_speed']))
logger.info ("temp            : " + str(wx['temp']))
logger.info ("temp_min        : " + str(wx['temp_min']))
logger.info ("temp_max        : " + str(wx['temp_max']))
logger.info ("temp_feels_like : " + str(wx['temp_feels_like']))
logger.info ("humidity        : " + str(wx['humidity']))
logger.info ("pressure        : " + str(wx['pressure']))
logger.info ("clouds          : " + str(wx['clouds']))
logger.info ("sunrise         : " + str(wx['sunrise']))
logger.info ("sunset          : " + str(wx['sunset']))
logger.info ("visibility      : " + str(wx['visibility']))
logger.info ("wx_description  : " + str(wx['wx_description']))
